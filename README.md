...
> Примечание: это даёт максимально высокий процент успешных иконок, но делает внешний запрос к Google. При желании можно заменить на приватный режим (через background + кеш).
...
## Лицензия
MIT (или поставь любую, которая тебе подходит).
